  ...
  fetch("http://localhost:5002/run-sensor", {
    ...
    .then((data) => {
      if (data.success) {
        ...
        if (data.ml_results) {
          console.log("SOURCE: RUN_SENSOR", data.ml_results);
...
const getColorClass = (label) => {
  ...
  const handleUploadCsv = async () => {
    ...
    try {
      ...
      if (pipeData.ml_results) {
        console.log("SOURCE: RUN_PIPELINE", pipeData.ml_results);
  ...
  return (
    <div className="flex flex-col items-center justify-start w-screen min-h-screen bg-black px-6 md:px-12 lg:px-20 pt-20 text-gray-200">
      ...
      <h1 className="text-5xl md:text-6xl font-extrabold mb-4">Check your Health</h1>
