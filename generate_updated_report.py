...
# Subtitle - NEW UWB FORMAT
subtitle = doc.add_paragraph()
subtitle.alignment = WD_PARAGRAPH_ALIGNMENT.CENTER
run = subtitle.add_run('UWB Radar Based Sleep Monitoring System for Physiological Signal Analysis')
run.font.size = Pt(12)
run.font.bold = True
...
print(f'Project Report title updated to UWB format: {output_path}')
