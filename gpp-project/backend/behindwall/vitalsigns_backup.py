...
# NOTE: BACK_CFG should point to a different profile file than FRONT_CFG
# If you don't have a specific Back profile, update the path below
# -----------------------------
...
# --- PATHS adjusted for integrated project ---
...
# Model script path (behind-wall enhanced model)
